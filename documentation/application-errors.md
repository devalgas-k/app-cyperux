...
Cyperux errors are meant to be specialized and internationalized. That mean you'll have to create dedicated exceptions extending `CyperuxException`, example:

```java
class UnknownFileToDeleteException extends CyperuxException {
