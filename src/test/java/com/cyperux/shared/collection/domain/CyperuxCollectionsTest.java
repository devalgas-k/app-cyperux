package com.cyperux.shared.collection.domain;
...
@UnitTest
class CyperuxCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class CyperuxCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = CyperuxCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = CyperuxCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class CyperuxCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = CyperuxCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = CyperuxCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class CyperuxCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = CyperuxCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = CyperuxCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class CyperuxMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = CyperuxCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = CyperuxCollections.immutable(input);
