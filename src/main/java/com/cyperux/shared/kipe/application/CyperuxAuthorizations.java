...
import com.cyperux.shared.authentication.application.AuthenticatedUser;
import com.cyperux.shared.authentication.domain.Role;
import com.cyperux.shared.authentication.domain.Roles;
import com.cyperux.shared.authentication.domain.Username;
import com.cyperux.shared.kipe.domain.Action;
import com.cyperux.shared.kipe.domain.Resource;
import com.cyperux.shared.kipe.domain.RolesAccesses;

@Component
public class CyperuxAuthorizations {

  private final RolesAccesses accesses;

  public CyperuxAuthorizations(Collection<RolesAccesses> accesses) {
